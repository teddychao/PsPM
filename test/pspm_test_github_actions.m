function pspm_test_github_actions(varargin)
	...
	suite = [...
		...
		TestSuite.fromClass(?pspm_ecg2hb_amri_test), ... % TestSuite.fromClass(?pspm_path_test), ...
	...
	import_suite = [...
		...
		TestSuite.fromClass(?import_eyelink_test), ... %TestSuite.fromClass(?import_viewpoint_test), TestSuite.fromClass(?import_smi_test), ...
	];
